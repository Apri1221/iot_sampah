...
export default {
    ...
    methods: {
        ...
        connect() {
            this.socket = new SockJS("https://sheltered-wave-88873.herokuapp.com/secured/room");
            ...
            this.stompClient.connect({}, frame => {
                ...
                this.stompClient.subscribe("/secured/user/queue/specific-user/" + this.clientId, tick => {
